...
public class Office {
    ...
    public Long getOfficeZip() {
        return officeZip;
    }

    public void setOfficeZip(Long officeZip) {
    ...
    public String getOfficeParking() {
        return officeParking;
    }

    public void setOfficeParking(String officeParking) {
        this.officeParking = officeParking;
    }
